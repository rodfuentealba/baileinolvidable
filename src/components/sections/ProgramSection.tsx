...
const programs = [
  { time: "16:00", description: "Llegada de invitados", icon: Users },
  { time: "17:00", description: "Ceremonia", icon: Church },
  { time: "18:00", description: "Aperitivo/Previa", icon: Wine },
  { time: "19:30", description: "Cena", icon: UtensilsCrossed },
  { time: "21:00", description: "Banda", icon: Music },
  { time: "22:30", description: "DJ Set", icon: Disc3 },
];
